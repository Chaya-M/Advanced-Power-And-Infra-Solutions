                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <h2 className="text-xl md:text-3xl font-black text-white mb-8 uppercase tracking-tighter italic">Technical <span className="text-energy-yellow underline decoration-4 underline-offset-8">Strength</span></h2>
                            ...
                            <div className="space-y-6">
                                {[
                                    ...
                                    <motion.div 
                                        ...
                                        className="flex items-center justify-between p-6 glass-panel border-white/5 rounded-2xl italic group hover:border-energy-yellow/20 transition-all duration-500"
                                    >
                        ...
                        <div className="relative">
                            <motion.div 
                                ...
                                className="aspect-[4/5] glass-panel border-white/5 rounded-[4rem] p-12 flex flex-col justify-end text-white relative overflow-hidden group"
                            >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <motion.div 
                                ...
                                transition={{ delay: idx * 0.1 }}
                                className="glass-panel border-white/5 p-10 rounded-[3rem] hover:border-energy-yellow/30 transition-all duration-500 group relative overflow-hidden"
                            >

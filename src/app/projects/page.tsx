                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    >
                        ...
                        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-6">
                            <h1 className="text-3xl md:text-7xl font-black tracking-tighter uppercase leading-tight md:leading-none">
                                Success <span className="text-energy-yellow italic">Story</span>
                            </h1>
                            
                            <div className="flex gap-6 sm:gap-8 pb-2">
                                <div className="flex flex-col items-center">
                                    <span className="text-2xl md:text-4xl font-black text-energy-yellow italic leading-none">450+</span>
                                    <span className="text-[8px] sm:text-[9px] font-black text-slate-400 uppercase tracking-widest mt-2">Successful Installs</span>
                                </div>
                                <div className="w-[1px] h-10 bg-white/10"></div>
                                <div className="flex flex-col items-center">
                                    <span className="text-2xl md:text-4xl font-black text-red-600 italic leading-none">15+</span>
                                    <span className="text-[8px] sm:text-[9px] font-black text-slate-400 uppercase tracking-widest mt-2">Years of Trust</span>
                                </div>
                            </div>
                        </div>
                        <p className="text-base md:text-xl text-slate-300 max-w-3xl leading-relaxed font-medium">
            ...
            <section className="py-12 !bg-[#F8F9F4] relative overflow-hidden border-t border-slate-200">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="flex flex-col items-center text-center mb-8">
                        ...
                        <h2 className="text-4xl md:text-8xl font-black uppercase tracking-tighter leading-tight md:leading-none" style={{ color: '#000000' }}>
                            TRUSTED LEADERS
                        </h2>
                    </div>
                </div>
